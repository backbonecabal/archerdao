CREATE TEMP FUNCTION
    ...
    LANGUAGE js AS """
    var abi = {"inputs": [], "name": "DISPATCHER_ADMIN_ROLE", "outputs": [{"internalType": "bytes32", "name": "", "type": "bytes32"}], "stateMutability": "view", "type": "function"};
...
WHERE to_address = '0xc9da1ac41e67059cb8a6fc641bd8abaafc72829d'
  AND STARTS_WITH(traces.input, '0x9ce3ec3d')
  )
SELECT
     block_timestamp
     ,block_number
